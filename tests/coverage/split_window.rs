...
#[test]
#[cfg_attr(not(feature = "coverage-tests"), ignore)]
fn split_window_fullsize_horizontal_02() {
...
#[test]
#[cfg_attr(not(feature = "coverage-tests"), ignore)]
fn split_window_print_format_02() {
...
#[test]
#[cfg_attr(not(feature = "coverage-tests"), ignore)]
fn split_window_environment_02() {
